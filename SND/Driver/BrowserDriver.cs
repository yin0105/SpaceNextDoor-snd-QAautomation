...
namespace SND.Driver
{
    ...
    public class BrowserDriver : IBrowserDriver
    {
        ...
        public BrowserDriver(TestContext testContext)
        {
            ...
            _baseUrl = "https://stag.spacenextdoor.com";
            Current = StartDriver("chrome"); //-headless /GridCHrome //chrome
        }
        ...
        public IWebDriver GetGridChrome()
        {
            ...
            var chromeDriver = new RemoteWebDriver(new Uri("http://192.168.100.112:4444/"), chromeOptions)
            {
                Url = _baseUrl
            };
